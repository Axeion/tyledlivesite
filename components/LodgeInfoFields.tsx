...
/**
 * The lodge-profile inputs, without the surrounding form: the lodge dashboard
 * and the platform admin submit them to different actions. Field names match
 * `LODGE_INFO_KEYS` in lib/lodge-info.ts.
 */
export function LodgeInfoFields({ lodge }: { lodge: Lodge }) {
